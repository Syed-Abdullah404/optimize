...
<?php
$query = $con->query('SELECT image FROM `services`');
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form role="form" class="text-start" method="POST" action="./Queries.php" enctype="multipart/form-data">
                    <div class="modal-body">
                        <input type="hidden" name="serId" id="serId" value="">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Name</label>
                            <input type="name" class="form-control" id="serName" name="serName" id="exampleInputEmail1">
                            <div class="mb-2 mt-3">
                                <label for="exampleInputPassword1" class="form-label">Description</label>
                            ...
                            <img src="images/service/<?php echo $row['image'] ?>" width="70px" height="70px">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<div class="modal fade " id="deleteexampleModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="./Queries.php" method="POST">
            <input type="hidden" name="SerIdDel" id="SerIdDel" value="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="delService">Yes</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                ...
                <button type="button" class="btn btn-primary my-4" data-bs-toggle="modal" data-bs-target="#addModal">Add Services<i class="fa fa-plus ms-2"></i></button>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><img src="images/service/<?php echo $row['image']; ?>" alt="" width="70px" height="70px"></td>
